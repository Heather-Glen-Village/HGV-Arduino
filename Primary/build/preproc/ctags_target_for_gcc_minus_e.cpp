...
void startSerial() {
  ...
  pinMode(6 /* Arduino Pin for RS485 Direction control, disable if you have module with hardware flow control*/, 0x1);
  digitalWrite(6 /* Arduino Pin for RS485 Direction control, disable if you have module with hardware flow control*/, 0x0); // Init Transceiver
    ...
    case 1: // SENDING:
      {
        if (Serial /* define serial port for RS485 interface, for Arduino Mega choose from Serial1, Serial2 or Serial3*/.availableForWrite() > 0 && txNdx == 0) {
          ...
          digitalWrite(6 /* Arduino Pin for RS485 Direction control, disable if you have module with hardware flow control*/, 0x1); // Enable RS485 Transmit
    ...
    case 2: // DELAY:
      {
        ...
        digitalWrite(6 /* Arduino Pin for RS485 Direction control, disable if you have module with hardware flow control*/, 0x0); // Disable RS485 Transmit
